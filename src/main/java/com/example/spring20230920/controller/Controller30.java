...
public class Controller30 {
    ...
    // /main30sub5?country1=germany&country2=france
    @GetMapping("sub5")
    ...
    public void method11(Integer id) {
        ...
        System.out.println(rows + "개 행 삭제");
    }
    ...
    public void method15(Integer id, Model model) {
        MyDto34Customers customers = dao.select15(id);
        model.addAttribute("customers", customers);
    }

    // POST
    // /main30/sub16
    // 고객정보 수정 -> /main20/sub15?id=3 로 redirect
    @PostMapping("sub16")
    public String method16(MyDto34Customers customers, RedirectAttributes rttr) {
        int rows = dao.update2(customers);
        ...
        rttr.addAttribute("id", customers.getId());
