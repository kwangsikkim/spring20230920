...
//    @RequestMapping(method = RequestMethod.DELETE, value = "sub6")
    ...
    // delete /main36/sub10
    // 일하는 메소드 작성
    // 3, 5, 7은 메소드 아규먼트로 받아서 콘솔에 출력하는 코드 작성
...
//        @DeleteMapping("sub10/{num}")
//        public void method10(@PathVariable Integer num) {  // 인자 셋 모두 이름이 같다면 ("num") 생략가능
//            System.out.println("n = " + n);
    }
