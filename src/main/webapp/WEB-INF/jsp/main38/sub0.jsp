    ...
    <script>
        function ajax4() {
            ...
            axios.get("/main38/sub4")
                .then(function (response) {
                    // console.log(response.data.city);        // "seoul"
                    // console.log(response.data.price);       // 3000
                    // console.log(response.data.list[0]);     // "son"
                    // console.log(response.data.birth);       // "1999-03-03"
                    const data = response.data;
                    console.log(data.city);        // "seoul"
                    console.log(data.price);       // 3000
                    console.log(data.list[0]);     // "son"
                    console.log(data.birth);       // "1999-03-03"
...
<script>
    ...
    // let {email, price} = c;
    let {email} = c; // 분해한 부분의 property만 할당 할 수도 있다.
    ...
    let {name2, address} = d;    // 부분만 destructuring assignment
    ...
    let  {name3, city3 = "인천", address3 = "신촌"} = f;   // 없을 때 기본값 할당, 있으면 적용 안됨
    console.log(name3);     // kim
    console.log(city3);     // busan
