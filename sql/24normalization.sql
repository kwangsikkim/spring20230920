...
INSERT INTO my_table22_person (name, school, skill1, skill2, skill3)
...
-- AUTO_INCREMENT 1부터 자동으로 1씩 증가된 값 삽입
...
INSERT INTO my_table25_person (ssn, name, scholl, skill)
VALUE ('080101', '흥민', '대학', '축구');
INSERT INTO my_table25_person (ssn, name, scholl, skill)
VALUE ('080101', '흥민', '대학', '노래');
INSERT INTO my_table25_person (ssn, name, scholl, skill)
    VALUE ('000101', '강인', '대학원', '농구');
INSERT INTO my_table25_person (ssn, name, scholl, skill)
    VALUE ('030101', '민재', '고등', '배구');
