...
SELECT * FROM customers WHERE Country = 'MEXICO'; -- 대소문자 구분 안 함

SELECT * FROM customers WHERE Country = 'France'; -- 문자열은 '' 안에
SELECT * FROM customers WHERE CustomerID = 3; -- 숫자 형식은 '' 없이
